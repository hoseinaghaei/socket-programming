...
def add_pear(ip: str, port: int) -> Peer:
...
def remove_pear(ip: str, port: int) -> None:
    global seeders_lock, seeders
...
def remove_peer_files(pear: Peer) -> None:
...
def handle_client_share_request(command, ip: str, port: int) -> str:
